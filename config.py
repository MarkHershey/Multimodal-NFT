...
default_configs = dict(
    ...
    audio_mfcc_dim=256,  # audio n_mfcc dimension (B, n_mfcc, T)
    audio_time_dim=3600,  # audio time dimension (B, n_mfcc, T)
    audio_mid_dim=128,  # audio mid representation dimension
